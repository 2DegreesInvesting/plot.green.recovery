...
p2 <- ggplot(
  ...
  scale_colour_one_in1000(labels = c("grey", "black"), name = "Automotive\n(as of end of year)") +
  scale_linetype_manual(values = c("dashed", "solid"), name = "Automotive\n(as of end of year)") +
...
p3 <- ggplot(
  ...
  scale_colour_one_in1000(labels = c("grey", "black"), name = "As of end of year") +
  scale_linetype_manual(values = c("dashed", "solid"), name = "As of end of year") +
  theme_green_recovery() %+replace%
  theme(
    legend.title = element_text(size = 16),
